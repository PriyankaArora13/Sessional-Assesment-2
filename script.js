window.onload = function () {
  ...
  x.onload = function () {
    ...
    for (let i = 0; i < json.length; i++) {
      ...
      ele.style.cssText =
        "background-color:cream;width: 25vw;border:2px solid black;display: inline-block;border-radius:10px 10px 10px 10px;margin-top:0.5rem";
      heading.style.cssText = "color:orange";
